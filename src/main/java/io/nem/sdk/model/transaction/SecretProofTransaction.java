...
public class SecretProofTransaction extends Transaction {
	 ...
	 */
	public static SecretProofTransaction create(final Deadline deadline, final BigInteger maxFee, final HashType hashType, final Address recipient,
												final String secret, final String proof,
