...
public final class AccountLinkTransactionBuffer extends Table {
    public static AccountLinkTransactionBuffer getRootAsAccountLinkTransactionBuffer(ByteBuffer _bb) {
        return getRootAsAccountLinkTransactionBuffer(_bb, new AccountLinkTransactionBuffer());
    }
    ...
    public AccountLinkTransactionBuffer __assign(int _i, ByteBuffer _bb) {
    ...
    public static int createAccountLinkTransactionBuffer(FlatBufferBuilder builder,
                                                         ...
                                                         int feeOffset,
                                                         int deadlineOffset,
                                                         int remoteAccountKey,
                                                         int linkAction) {
        builder.startObject(9);
        AccountLinkTransactionBuffer.addRemoteAccountKey(builder, remoteAccountKey);
        ...
        AccountLinkTransactionBuffer.addFee(builder, feeOffset);
    ...
    public static void addSignature(FlatBufferBuilder builder, int signatureOffset) {
        builder.addInt(1, signatureOffset, 0);
    }
    public static void addSigner(FlatBufferBuilder builder, int signerOffset) {
        builder.addInt(2, signerOffset, 0);
    }
    public static void addVersion(FlatBufferBuilder builder, int version) {
        builder.addInt(3,(short) version, (short) 0);
    }
    public static void addType(FlatBufferBuilder builder, int type) {
        builder.addInt(4, (short)type, (short)0);
    }
    public static void addFee(FlatBufferBuilder builder, int feeOffset) {
        builder.addLong(5, feeOffset, 0);
    }
    public static void addDeadline(FlatBufferBuilder builder, int deadlineOffset) {
        builder.addInt(6, deadlineOffset, 0);
    }
    public static void addRemoteAccountKey(FlatBufferBuilder builder, int remoteAccountKey) {
        builder.addInt(7, remoteAccountKey, 0);
    }
    public static void addLinkAction(FlatBufferBuilder builder, int linkAction) {
        builder.addInt(8, linkAction, 0);
    }
    ...
    public static void finishAccountLinkTransactionBufferBuffer(FlatBufferBuilder builder, int offset) {
