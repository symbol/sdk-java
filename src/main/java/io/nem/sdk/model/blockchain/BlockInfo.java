...
public class BlockInfo {
	...
	private BlockInfo(String hash, String generationHash, BigInteger totalFee, Integer numTransactions, List<String> subCacheMerkleRoots,
					  String signature,
					  ...
					  String blockTransactionsHash, String blockReceiptsHash, String stateHash,
	...
	public static BlockInfo create(String hash, String generationHash, BigInteger totalFee, Integer numTransactions,
								   List<String> subCacheMerkleRoots,
								   String signature, String signer, Integer blockVersion, int type, BigInteger height, BigInteger timestamp,
								   BigInteger difficulty, Integer feeMultiplier, String previousBlockHash, String blockTransactionsHash,
								   String blockReceiptsHash, String stateHash, String beneficiaryPublicKey) {
		...
		return new BlockInfo(hash, generationHash, totalFee, numTransactions, subCacheMerkleRoots, signature, signerPublicAccount, networkType,
				transactionVersion, type, height, timestamp, difficulty, feeMultiplier, previousBlockHash, blockTransactionsHash,
				blockReceiptsHash, stateHash, beneficiaryPublicAccount);
	}
