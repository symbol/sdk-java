...
public class ChainInfo {
	 ...
	 */
	public ChainInfo(final BigInteger numberOfBlocks, final BigInteger scoreHigh, final BigInteger scoreLow) {
	 ...
	 * @return Chain info.
	 */
	public static ChainInfo create(final BigInteger numberOfBlocks, final BigInteger scoreHigh, final BigInteger scoreLow) {
