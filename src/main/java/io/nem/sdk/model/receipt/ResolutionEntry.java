...
public class ResolutionEntry<T> {
    ...
    private void validateResolvedType() {
        ...
        if (!AddressAlias.class.isAssignableFrom(resolutionClass) && !MosaicAlias.class.isAssignableFrom(resolutionClass)) {
            throw new IllegalArgumentException("Resolved type: [" + resolutionClass.getName() + "] is not valid for this ResolutionEntry");
        }
    }
}
