...
public class NetworkRoutesApi {
    ...
    private okhttp3.Call getNetworkTypeValidateBeforeCall(final ApiCallback _callback)
        throws ApiException {
    ...
    public ApiResponse<NetworkTypeDTO> getNetworkTypeWithHttpInfo() throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<NetworkTypeDTO>() {
        }.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get the current network type of the chain (asynchronously) Returns the current network type.
     *
     ...
     * </table>
     */
    public okhttp3.Call getNetworkTypeAsync(final ApiCallback<NetworkTypeDTO> _callback)
        throws ApiException {
