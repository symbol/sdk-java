...
import io.nem.sdk.infrastructure.auth.ApiKeyAuth;
import io.nem.sdk.infrastructure.auth.Authentication;
import io.nem.sdk.infrastructure.auth.HttpBasicAuth;
import java.io.File;
...
public class ApiClient {
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/0.7.15/java");
            ...
            if (returnType == null || response.code() == 204) {
                ...
                if (response.body() != null) {
                    try {
                        ...
                        throw new ApiException(
                            response.message(), e, response.code(),
                            response.headers().toMultimap());
                    }
                }
                return null;
        ...
        try {
            ...
            if (keyManagers != null || trustManagers != null) {
                ...
                httpClient =
                    httpClient
                        .newBuilder()
                        .sslSocketFactory(null, (X509TrustManager) trustManagers[0])
                        .build();
            }
