...
public class StatementsDTO {
    ...
    public static final String SERIALIZED_NAME_ADDRESS_RESOLUTION_STATEMENTS =
        "addressResolutionStatements";
    public static final String SERIALIZED_NAME_MOSAIC_RESOLUTION_STATEMENTS =
        "mosaicResolutionStatements";
    @SerializedName(SERIALIZED_NAME_TRANSACTION_STATEMENTS)
    private List<TransactionStatementDTO> transactionStatements =
        new ArrayList<TransactionStatementDTO>();
    @SerializedName(SERIALIZED_NAME_ADDRESS_RESOLUTION_STATEMENTS)
    private List<ResolutionStatementDTO> addressResolutionStatements =
        new ArrayList<ResolutionStatementDTO>();
    @SerializedName(SERIALIZED_NAME_MOSAIC_RESOLUTION_STATEMENTS)
    private List<ResolutionStatementDTO> mosaicResolutionStatements =
        new ArrayList<ResolutionStatementDTO>();

    public StatementsDTO transactionStatements(
        List<TransactionStatementDTO> transactionStatements) {
        this.transactionStatements = transactionStatements;
        return this;
    }

    public StatementsDTO addTransactionStatementsItem(
        TransactionStatementDTO transactionStatementsItem) {
    ...
    @ApiModelProperty(
        required = true,
        value = "The array of transaction statements for the block requested.")
    ...
    public StatementsDTO addressResolutionStatements(
        List<ResolutionStatementDTO> addressResolutionStatements) {
        this.addressResolutionStatements = addressResolutionStatements;
        return this;
    }

    public StatementsDTO addAddressResolutionStatementsItem(
        ResolutionStatementDTO addressResolutionStatementsItem) {
    ...
    @ApiModelProperty(
        required = true,
        value = "The array of address resolutions for the block requested.")
    public List<ResolutionStatementDTO> getAddressResolutionStatements() {
        return addressResolutionStatements;
    }

    public void setAddressResolutionStatements(
        List<ResolutionStatementDTO> addressResolutionStatements) {
        this.addressResolutionStatements = addressResolutionStatements;
    }

    public StatementsDTO mosaicResolutionStatements(
        List<ResolutionStatementDTO> mosaicResolutionStatements) {
        this.mosaicResolutionStatements = mosaicResolutionStatements;
        return this;
    }

    public StatementsDTO addMosaicResolutionStatementsItem(
        ResolutionStatementDTO mosaicResolutionStatementsItem) {
    ...
    @ApiModelProperty(
        required = true,
        value = "The array of mosaic resolutions for the block requested.")
    public List<ResolutionStatementDTO> getMosaicResolutionStatements() {
        return mosaicResolutionStatements;
    }

    public void setMosaicResolutionStatements(
        List<ResolutionStatementDTO> mosaicResolutionStatements) {
        this.mosaicResolutionStatements = mosaicResolutionStatements;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.transactionStatements, statementsDTO.transactionStatements)
            && Objects.equals(
            this.addressResolutionStatements, statementsDTO.addressResolutionStatements)
            && Objects.equals(
            this.mosaicResolutionStatements, statementsDTO.mosaicResolutionStatements);
    }
    ...
    public String toString() {
        ...
        sb.append("    transactionStatements: ")
            .append(toIndentedString(transactionStatements))
            .append("\n");
        sb.append("    addressResolutionStatements: ")
            .append(toIndentedString(addressResolutionStatements))
            .append("\n");
        sb.append("    mosaicResolutionStatements: ")
            .append(toIndentedString(mosaicResolutionStatements))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
