...
public class BlockDTO {
    ...
    /**
     * The signature of the block. The signature was generated by the signer and can be used to
    ...
    @ApiModelProperty(
        example =
            "D8047EB8285077D9900EDD42F4081070DDB26E08E7F15A3E29642C80CF0C7D68340682DC9868C73EB09744D6298146D8DFC02ED47070FC81FB47D6F73B33EF0A",
        required = true,
        value =
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "The public key of the block harvester formatted as hexadecimal.")
    ...
    /**
     * The entity version. The higher byte represents the network identifier: * 0x68 (MAIN_NET) -
     * Public main network. * 0x98 (TEST_NET) - Public test network. * 0x60 (MIJIN) - Private
     * network. * 0x90 (MIJIN_TEST) - Private test network.
     *
     * @return version
     */
    @ApiModelProperty(
    ...
    /**
     * The block type: * 0x8043 (32835 decimal) - Nemesis block. * 0x8143 (33091 decimal) - Regular
     * block.
     *
     * @return type
     */
    ...
    @ApiModelProperty(
        example = "0",
        required = true,
        value = "The fee multiplier applied to transactions contained in block.")
    ...
    /**
     * The transactions included in a block are hashed forming a merkle tree. The root of the tree
     * summarizes them.
     *
    ...
    /**
     * The collection of receipts are hashed into a merkle tree and linked to a block. The block
     * header stores the root hash.
     *
    ...
    @ApiModelProperty(
        example = "0",
        required = true,
        value = "The public key of the optional beneficiary designated by harvester.")
    ...
    public String toString() {
        ...
        sb.append("    previousBlockHash: ").append(toIndentedString(previousBlockHash))
            .append("\n");
        sb.append("    blockTransactionsHash: ")
            .append(toIndentedString(blockTransactionsHash))
            .append("\n");
        sb.append("    blockReceiptsHash: ").append(toIndentedString(blockReceiptsHash))
            .append("\n");
