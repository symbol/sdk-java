...
public class NodeInfoDTO {
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "The public key used to identify the node.")
    ...
    @ApiModelProperty(
        example = "7900",
        required = true,
        value = "The port used for the communication.")
    ...
    @ApiModelProperty(
        example = "127.0.0.1",
        required = true,
        value = "The IP address of the endpoint.")
    ...
    public String toString() {
        ...
        sb.append("    networkIdentifier: ").append(toIndentedString(networkIdentifier))
            .append("\n");
