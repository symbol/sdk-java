...
public enum AccountRestrictionModificationActionDto {
    ...
    public static AccountRestrictionModificationActionDto rawValueOf(final byte value) {
        for (AccountRestrictionModificationActionDto current : AccountRestrictionModificationActionDto
            .values()) {
        ...
        throw new IllegalArgumentException(
            value + " was not a backing value for AccountRestrictionModificationActionDto.");
    }
