...
public final class NamespaceRegistrationTransactionBuilder extends TransactionBuilder {
     ...
     */
    protected NamespaceRegistrationTransactionBuilder(final SignatureDto signature,
        final KeyDto signer, final short version, final EntityTypeDto type, final AmountDto fee,
        final TimestampDto deadline, final BlockDurationDto duration, final NamespaceIdDto id,
    ...
    protected NamespaceRegistrationTransactionBuilder(final SignatureDto signature,
        final KeyDto signer, final short version, final EntityTypeDto type, final AmountDto fee,
        final TimestampDto deadline, final NamespaceIdDto parentId, final NamespaceIdDto id,
        final ByteBuffer name) {
        super(signature, signer, version, type, fee, deadline);
        this.namespaceRegistrationTransactionBody = NamespaceRegistrationTransactionBodyBuilder
     ...
     */
    public static NamespaceRegistrationTransactionBuilder create(final SignatureDto signature,
        final KeyDto signer, final short version, final EntityTypeDto type, final AmountDto fee,
        final TimestampDto deadline, final BlockDurationDto duration, final NamespaceIdDto id,
        final ByteBuffer name) {
        return new NamespaceRegistrationTransactionBuilder(signature, signer, version, type, fee,
            deadline, duration, id, name);
    }
