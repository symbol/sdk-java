...
public final class AccountOperationRestrictionModificationBuilder
   ...
   * @param value Value.
   */
  protected AccountOperationRestrictionModificationBuilder(
      final AccountRestrictionModificationTypeDto modificationType, final EntityTypeDto value) {
   ...
   */
  public static AccountOperationRestrictionModificationBuilder create(
      final AccountRestrictionModificationTypeDto modificationType, final EntityTypeDto value) {
   ...
   * @return Instance of AccountOperationRestrictionModificationBuilder.
   */
  public static AccountOperationRestrictionModificationBuilder loadFromBinary(
