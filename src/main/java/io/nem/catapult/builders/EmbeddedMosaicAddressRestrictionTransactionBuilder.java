 ...
 */
public final class EmbeddedMosaicAddressRestrictionTransactionBuilder extends
     ...
     */
    protected EmbeddedMosaicAddressRestrictionTransactionBuilder(final KeyDto signer,
     ...
     */
    public static EmbeddedMosaicAddressRestrictionTransactionBuilder create(final KeyDto signer,
        final short version, final EntityTypeDto type, final UnresolvedMosaicIdDto mosaicId,
        final long restrictionKey, final UnresolvedAddressDto targetAddress,
        final long previousRestrictionValue, final long newRestrictionValue) {
        return new EmbeddedMosaicAddressRestrictionTransactionBuilder(signer, version, type,
            mosaicId, restrictionKey, targetAddress, previousRestrictionValue, newRestrictionValue);
    }
     ...
     * @return Instance of EmbeddedMosaicAddressRestrictionTransactionBuilder.
     */
    public static EmbeddedMosaicAddressRestrictionTransactionBuilder loadFromBinary(
