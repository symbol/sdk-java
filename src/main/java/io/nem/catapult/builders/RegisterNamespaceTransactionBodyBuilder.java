...
final class RegisterNamespaceTransactionBodyBuilder {
   ...
   */
  protected RegisterNamespaceTransactionBodyBuilder(
      final BlockDurationDto duration, final NamespaceIdDto namespaceId, final ByteBuffer name) {
   ...
   */
  protected RegisterNamespaceTransactionBodyBuilder(
      final NamespaceIdDto parentId, final NamespaceIdDto namespaceId, final ByteBuffer name) {
   ...
   */
  public static RegisterNamespaceTransactionBodyBuilder create(
      final BlockDurationDto duration, final NamespaceIdDto namespaceId, final ByteBuffer name) {
