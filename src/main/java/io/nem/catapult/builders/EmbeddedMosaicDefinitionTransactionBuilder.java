...
public final class EmbeddedMosaicDefinitionTransactionBuilder extends EmbeddedTransactionBuilder {
   ...
   */
  protected EmbeddedMosaicDefinitionTransactionBuilder(
      final KeyDto signer,
      final short version,
      final EntityTypeDto type,
      final MosaicNonceDto mosaicNonce,
      final MosaicIdDto mosaicId,
      final EnumSet<MosaicFlagsDto> flags,
      final byte divisibility,
      final ArrayList<MosaicPropertyBuilder> properties) {
    super(signer, version, type);
    this.mosaicDefinitionTransactionBody =
        MosaicDefinitionTransactionBodyBuilder.create(
            mosaicNonce, mosaicId, flags, divisibility, properties);
  }
   ...
   */
  public static EmbeddedMosaicDefinitionTransactionBuilder create(
      final KeyDto signer,
      final short version,
      final EntityTypeDto type,
      final MosaicNonceDto mosaicNonce,
    ...
    return new EmbeddedMosaicDefinitionTransactionBuilder(
        signer, version, type, mosaicNonce, mosaicId, flags, divisibility, properties);
  }
  ...
  public byte[] serialize() {
    return GeneratorUtils.serialize(
        dataOutputStream -> {
          ...
          final byte[] mosaicDefinitionTransactionBodyBytes =
              this.mosaicDefinitionTransactionBody.serialize();
          dataOutputStream.write(
              mosaicDefinitionTransactionBodyBytes, 0, mosaicDefinitionTransactionBodyBytes.length);
        });
  }
}
