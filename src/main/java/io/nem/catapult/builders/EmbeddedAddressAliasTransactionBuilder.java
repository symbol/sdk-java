...
public final class EmbeddedAddressAliasTransactionBuilder extends EmbeddedTransactionBuilder {
   ...
   */
  protected EmbeddedAddressAliasTransactionBuilder(
      final KeyDto signer,
      final short version,
   ...
   */
  public static EmbeddedAddressAliasTransactionBuilder create(
      final KeyDto signer,
      final short version,
      final EntityTypeDto type,
      final AliasActionDto aliasAction,
    ...
    return new EmbeddedAddressAliasTransactionBuilder(
        signer, version, type, aliasAction, namespaceId, address);
  }
