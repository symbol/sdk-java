...
public final class EmbeddedAccountOperationRestrictionTransactionBuilder
    extends EmbeddedTransactionBuilder {
  /** Account operation restriction transaction body. */
  private final AccountOperationRestrictionTransactionBodyBuilder
  ...
  protected EmbeddedAccountOperationRestrictionTransactionBuilder(final DataInput stream) {
    super(stream);
    this.accountOperationRestrictionTransactionBody =
  ...
  protected EmbeddedAccountOperationRestrictionTransactionBuilder(
    ...
    this.accountOperationRestrictionTransactionBody =
        AccountOperationRestrictionTransactionBodyBuilder.create(restrictionType, modifications);
  }
   ...
   */
  public static EmbeddedAccountOperationRestrictionTransactionBuilder create(
      final KeyDto signer,
      final short version,
      final EntityTypeDto type,
      final AccountRestrictionTypeDto restrictionType,
    ...
    return new EmbeddedAccountOperationRestrictionTransactionBuilder(
        signer, version, type, restrictionType, modifications);
  }
   ...
   * @return Instance of EmbeddedAccountOperationRestrictionTransactionBuilder.
   */
  public static EmbeddedAccountOperationRestrictionTransactionBuilder loadFromBinary(
  ...
  public byte[] serialize() {
    return GeneratorUtils.serialize(
        dataOutputStream -> {
          ...
          final byte[] accountOperationRestrictionTransactionBodyBytes =
              this.accountOperationRestrictionTransactionBody.serialize();
          dataOutputStream.write(
              accountOperationRestrictionTransactionBodyBytes,
              0,
