...
final class MosaicGlobalRestrictionTransactionBodyBuilder {
     ...
     */
    protected MosaicGlobalRestrictionTransactionBodyBuilder(final UnresolvedMosaicIdDto mosaicId,
     ...
     */
    public static MosaicGlobalRestrictionTransactionBodyBuilder create(
        final UnresolvedMosaicIdDto mosaicId, final UnresolvedMosaicIdDto referenceMosaicId,
        final long restrictionKey, final long previousRestrictionValue,
        final MosaicRestrictionTypeDto previousRestrictionType, final long newRestrictionValue,
        final MosaicRestrictionTypeDto newRestrictionType) {
        return new MosaicGlobalRestrictionTransactionBodyBuilder(mosaicId, referenceMosaicId,
            restrictionKey, previousRestrictionValue, previousRestrictionType, newRestrictionValue,
            newRestrictionType);
    }
     ...
     * @return Instance of MosaicGlobalRestrictionTransactionBodyBuilder.
     */
    public static MosaicGlobalRestrictionTransactionBodyBuilder loadFromBinary(
    ...
    public byte[] serialize() {
        return GeneratorUtils.serialize(dataOutputStream -> {
            ...
            dataOutputStream
                .write(previousRestrictionTypeBytes, 0, previousRestrictionTypeBytes.length);
