...
public final class EmbeddedSecretLockTransactionBuilder extends EmbeddedTransactionBuilder {
   ...
   */
  protected EmbeddedSecretLockTransactionBuilder(
      final KeyDto signer,
      final short version,
    ...
    this.secretLockTransactionBody =
        SecretLockTransactionBodyBuilder.create(mosaic, duration, hashAlgorithm, secret, recipient);
  }
   ...
   */
  public static EmbeddedSecretLockTransactionBuilder create(
      final KeyDto signer,
      final short version,
      final EntityTypeDto type,
      final UnresolvedMosaicBuilder mosaic,
    ...
    return new EmbeddedSecretLockTransactionBuilder(
        signer, version, type, mosaic, duration, hashAlgorithm, secret, recipient);
  }
    ...
    return GeneratorUtils.serialize(
        dataOutputStream -> {
          ...
          dataOutputStream.write(
              secretLockTransactionBodyBytes, 0, secretLockTransactionBodyBytes.length);
        });
  }
}
