...
final class NamespaceMetadataTransactionBodyBuilder {
     ...
     */
    protected NamespaceMetadataTransactionBodyBuilder(final KeyDto targetPublicKey,
     ...
     */
    public static NamespaceMetadataTransactionBodyBuilder create(final KeyDto targetPublicKey,
        final long scopedMetadataKey, final NamespaceIdDto targetNamespaceId,
        final short valueSizeDelta, final ByteBuffer value) {
        return new NamespaceMetadataTransactionBodyBuilder(targetPublicKey, scopedMetadataKey,
            targetNamespaceId, valueSizeDelta, value);
    }
