...
final class MultisigAccountModificationTransactionBodyBuilder {
    ...
    /**
     * Relative change of the minimal number of cosignatories required when approving a
     * transaction.
     */
     ...
     */
    protected MultisigAccountModificationTransactionBodyBuilder(final byte minRemovalDelta,
     ...
     */
    public static MultisigAccountModificationTransactionBodyBuilder create(
        final byte minRemovalDelta, final byte minApprovalDelta,
        final ArrayList<CosignatoryModificationBuilder> modifications) {
        return new MultisigAccountModificationTransactionBodyBuilder(minRemovalDelta,
            minApprovalDelta, modifications);
    }
     ...
     * @return Instance of MultisigAccountModificationTransactionBodyBuilder.
     */
    public static MultisigAccountModificationTransactionBodyBuilder loadFromBinary(
