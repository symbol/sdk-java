...
public final class AddressAliasTransactionBuilder extends TransactionBuilder {
   ...
   */
  protected AddressAliasTransactionBuilder(
    ...
    this.addressAliasTransactionBody =
        AddressAliasTransactionBodyBuilder.create(aliasAction, namespaceId, address);
  }
   ...
   */
  public static AddressAliasTransactionBuilder create(
      final SignatureDto signature,
      final KeyDto signer,
      final short version,
      final EntityTypeDto type,
    ...
    return new AddressAliasTransactionBuilder(
        signature, signer, version, type, fee, deadline, aliasAction, namespaceId, address);
  }
  ...
  public byte[] serialize() {
    return GeneratorUtils.serialize(
        dataOutputStream -> {
          ...
          final byte[] addressAliasTransactionBodyBytes =
              this.addressAliasTransactionBody.serialize();
          dataOutputStream.write(
              addressAliasTransactionBodyBytes, 0, addressAliasTransactionBodyBytes.length);
        });
  }
}
