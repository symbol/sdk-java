...
public final class EmbeddedAccountAddressRestrictionTransactionBuilder
  ...
  private final AccountAddressRestrictionTransactionBodyBuilder
  ...
  protected EmbeddedAccountAddressRestrictionTransactionBuilder(final DataInput stream) {
    super(stream);
    this.accountAddressRestrictionTransactionBody =
  ...
  protected EmbeddedAccountAddressRestrictionTransactionBuilder(
    ...
    this.accountAddressRestrictionTransactionBody =
        AccountAddressRestrictionTransactionBodyBuilder.create(restrictionType, modifications);
  }
   ...
   */
  public static EmbeddedAccountAddressRestrictionTransactionBuilder create(
      final KeyDto signer,
      final short version,
      final EntityTypeDto type,
      final AccountRestrictionTypeDto restrictionType,
   ...
   * @return Instance of EmbeddedAccountAddressRestrictionTransactionBuilder.
   */
  public static EmbeddedAccountAddressRestrictionTransactionBuilder loadFromBinary(
  ...
  public byte[] serialize() {
    return GeneratorUtils.serialize(
        dataOutputStream -> {
          ...
          final byte[] accountAddressRestrictionTransactionBodyBytes =
              this.accountAddressRestrictionTransactionBody.serialize();
          dataOutputStream.write(
              accountAddressRestrictionTransactionBodyBytes,
              0,
