 ...
 */
public final class EmbeddedAccountAddressRestrictionTransactionBuilder extends
     ...
     */
    protected EmbeddedAccountAddressRestrictionTransactionBuilder(final KeyDto signer,
     ...
     */
    public static EmbeddedAccountAddressRestrictionTransactionBuilder create(final KeyDto signer,
        final short version, final EntityTypeDto type,
        final AccountRestrictionTypeDto restrictionType,
        final ArrayList<AccountAddressRestrictionModificationBuilder> modifications) {
        return new EmbeddedAccountAddressRestrictionTransactionBuilder(signer, version, type,
