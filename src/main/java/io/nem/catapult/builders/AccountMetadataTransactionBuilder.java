...
public final class AccountMetadataTransactionBuilder extends TransactionBuilder {
     ...
     */
    protected AccountMetadataTransactionBuilder(final SignatureDto signature, final KeyDto signer,
     ...
     */
    public static AccountMetadataTransactionBuilder create(final SignatureDto signature,
        final KeyDto signer, final short version, final EntityTypeDto type, final AmountDto fee,
        final TimestampDto deadline, final KeyDto targetPublicKey, final long scopedMetadataKey,
        final short valueSizeDelta, final ByteBuffer value) {
        return new AccountMetadataTransactionBuilder(signature, signer, version, type, fee,
            deadline, targetPublicKey, scopedMetadataKey, valueSizeDelta, value);
    }
