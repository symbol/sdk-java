...
final class MosaicAddressRestrictionTransactionBodyBuilder {
     ...
     */
    protected MosaicAddressRestrictionTransactionBodyBuilder(final UnresolvedMosaicIdDto mosaicId,
     ...
     */
    public static MosaicAddressRestrictionTransactionBodyBuilder create(
        final UnresolvedMosaicIdDto mosaicId, final long restrictionKey,
        final UnresolvedAddressDto targetAddress, final long previousRestrictionValue,
        final long newRestrictionValue) {
        return new MosaicAddressRestrictionTransactionBodyBuilder(mosaicId, restrictionKey,
            targetAddress, previousRestrictionValue, newRestrictionValue);
    }
     ...
     * @return Instance of MosaicAddressRestrictionTransactionBodyBuilder.
     */
    public static MosaicAddressRestrictionTransactionBodyBuilder loadFromBinary(
