...
final class NamespaceRegistrationTransactionBodyBuilder {
     ...
     */
    protected NamespaceRegistrationTransactionBodyBuilder(final BlockDurationDto duration,
     ...
     * @param name Namespace name.
     */
    protected NamespaceRegistrationTransactionBodyBuilder(final NamespaceIdDto parentId,
        final NamespaceIdDto id, final ByteBuffer name) {
     ...
     */
    public static NamespaceRegistrationTransactionBodyBuilder create(
        final BlockDurationDto duration, final NamespaceIdDto id, final ByteBuffer name) {
     ...
     * @return Instance of NamespaceRegistrationTransactionBodyBuilder.
     */
    public static NamespaceRegistrationTransactionBodyBuilder create(final NamespaceIdDto parentId,
        final NamespaceIdDto id, final ByteBuffer name) {
     ...
     * @return Instance of NamespaceRegistrationTransactionBodyBuilder.
     */
    public static NamespaceRegistrationTransactionBodyBuilder loadFromBinary(
