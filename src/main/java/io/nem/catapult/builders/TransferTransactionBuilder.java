...
public final class TransferTransactionBuilder extends TransactionBuilder {
   ...
   */
  protected TransferTransactionBuilder(
    ...
    this.transferTransactionBody =
        TransferTransactionBodyBuilder.create(recipient, message, mosaics);
  }
   ...
   */
  public static TransferTransactionBuilder create(
      final SignatureDto signature,
      final KeyDto signer,
      final short version,
      final EntityTypeDto type,
    ...
    return new TransferTransactionBuilder(
        signature, signer, version, type, fee, deadline, recipient, message, mosaics);
  }
    ...
    return GeneratorUtils.serialize(
        dataOutputStream -> {
          ...
          dataOutputStream.write(
              transferTransactionBodyBytes, 0, transferTransactionBodyBytes.length);
        });
  }
}
