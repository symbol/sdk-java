...
final class MosaicMetadataTransactionBodyBuilder {
     ...
     */
    protected MosaicMetadataTransactionBodyBuilder(final KeyDto targetPublicKey,
     ...
     */
    public static MosaicMetadataTransactionBodyBuilder create(final KeyDto targetPublicKey,
        final long scopedMetadataKey, final UnresolvedMosaicIdDto targetMosaicId,
        final short valueSizeDelta, final ByteBuffer value) {
        return new MosaicMetadataTransactionBodyBuilder(targetPublicKey, scopedMetadataKey,
            targetMosaicId, valueSizeDelta, value);
    }
