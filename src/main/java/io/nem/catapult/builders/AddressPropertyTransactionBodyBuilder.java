...
final class AddressPropertyTransactionBodyBuilder {
    /** Property type. */
    private final PropertyTypeDto propertyType;
    /** Property modifications. */
    private final ArrayList<AddressPropertyModificationBuilder> modifications;
     ...
     */
    protected AddressPropertyTransactionBodyBuilder(final DataInput stream) {
        try {
            ...
            for (int i = 0; i < modificationsCount; i++) {
                modifications.add(AddressPropertyModificationBuilder.loadFromBinary(stream));
            }
        } catch(Exception e) {
     ...
     */
    protected AddressPropertyTransactionBodyBuilder(final PropertyTypeDto propertyType, final ArrayList<AddressPropertyModificationBuilder> modifications) {
    ...
    /**
     * Creates an instance of AddressPropertyTransactionBodyBuilder.
     *
     * @param propertyType Property type.
     * @param modifications Property modifications.
     * @return Instance of AddressPropertyTransactionBodyBuilder.
     */
    public static AddressPropertyTransactionBodyBuilder create(final PropertyTypeDto propertyType, final ArrayList<AddressPropertyModificationBuilder> modifications) {
        return new AddressPropertyTransactionBodyBuilder(propertyType, modifications);
    }
    ...
    /**
     * Creates an instance of AddressPropertyTransactionBodyBuilder from a stream.
     *
     * @param stream Byte stream to use to serialize the object.
     * @return Instance of AddressPropertyTransactionBodyBuilder.
     */
    public static AddressPropertyTransactionBodyBuilder loadFromBinary(final DataInput stream) {
        return new AddressPropertyTransactionBodyBuilder(stream);
    }
