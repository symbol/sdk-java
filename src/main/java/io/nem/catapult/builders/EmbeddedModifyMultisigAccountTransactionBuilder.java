...
public final class EmbeddedModifyMultisigAccountTransactionBuilder
  ...
  protected EmbeddedModifyMultisigAccountTransactionBuilder(final DataInput stream) {
    super(stream);
    this.modifyMultisigAccountTransactionBody =
        ModifyMultisigAccountTransactionBodyBuilder.loadFromBinary(stream);
  }
   ...
   */
  protected EmbeddedModifyMultisigAccountTransactionBuilder(
      final KeyDto signer,
      final short version,
    ...
    this.modifyMultisigAccountTransactionBody =
        ModifyMultisigAccountTransactionBodyBuilder.create(
   ...
   */
  public static EmbeddedModifyMultisigAccountTransactionBuilder create(
      final KeyDto signer,
      final short version,
      final EntityTypeDto type,
      final byte minRemovalDelta,
      final byte minApprovalDelta,
      final ArrayList<CosignatoryModificationBuilder> modifications) {
    return new EmbeddedModifyMultisigAccountTransactionBuilder(
        signer, version, type, minRemovalDelta, minApprovalDelta, modifications);
  }
   ...
   * @return Instance of EmbeddedModifyMultisigAccountTransactionBuilder.
   */
  public static EmbeddedModifyMultisigAccountTransactionBuilder loadFromBinary(
  ...
  public byte[] serialize() {
    return GeneratorUtils.serialize(
        dataOutputStream -> {
          ...
          final byte[] modifyMultisigAccountTransactionBodyBytes =
              this.modifyMultisigAccountTransactionBody.serialize();
          dataOutputStream.write(
              modifyMultisigAccountTransactionBodyBytes,
              0,
              modifyMultisigAccountTransactionBodyBytes.length);
        });
  }
}
