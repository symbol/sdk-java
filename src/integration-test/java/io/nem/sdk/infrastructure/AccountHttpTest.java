...
class AccountHttpTest extends BaseTest {
    ...
    @BeforeAll
    void setup() {
        /* initializations done in BaseTest class */
    }
    ...
    void getAccountInfo() throws ExecutionException, InterruptedException, IOException {
        AccountInfo accountInfo =
            this.getAccountHttp().getAccountInfo(this.getTestAccountAddress()).toFuture().get();
    ...
    void transactions() throws ExecutionException, InterruptedException, IOException {
        List<Transaction> transactions =
            this.getAccountHttp().transactions(this.getTestPublicAccount()).toFuture().get();
    ...
    void incomingTransactions() throws ExecutionException, InterruptedException, IOException {
        List<Transaction> transactions =
            this.getAccountHttp().incomingTransactions(this.getTestPublicAccount()).toFuture()
                .get();
    ...
    void outgoingTransactions() throws ExecutionException, InterruptedException, IOException {
        List<Transaction> transactions =
            this.getAccountHttp().outgoingTransactions(this.getTestPublicAccount()).toFuture()
                .get();
    ...
    @Test
    void aggregateBondedTransactions()
        throws ExecutionException, InterruptedException, IOException {
    ...
    void unconfirmedTransactions() throws ExecutionException, InterruptedException, IOException {
        List<Transaction> transactions =
            this.getAccountHttp().unconfirmedTransactions(this.getTestPublicAccount()).toFuture()
                .get();
