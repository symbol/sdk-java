...
public class TransactionStatementTest {
    ...
    public static void setup() {
        ...
        Address recipientAddress = new Address("SDGLFW-DSHILT-IUHGIB-H5UGX2-VYF5VN-JEKCCD-BR26", NetworkType.MIJIN_TEST);
    ...
    void shouldCreateAddressResolutionTransactionStatement() {
        TransactionStatement transactionStatement = new TransactionStatement(BigInteger.TEN, receiptSource, receipts);
