...
public class MosaicNonceTest {
    ...
    void createNonceFromBigInteger() {
        ...
        assertTrue(Arrays.equals(nonce1.getNonce(), MosaicNonce.createFromHex("00000000").getNonce()));
        assertTrue(Arrays.equals(nonce2.getNonce(), MosaicNonce.createFromHex("FFFFFFFF").getNonce()));
    }
}
