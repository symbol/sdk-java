...
class LockFundsTransactionTest {
    ...
    void serialization() {
        String expected = "";
    ...
    void toAggregate() {
        String expected =  "600000009a49366406aca952b88badf5f1e9be6ce4968141035a60be503273ea65456b240190484144b262c46ceabb85809698000000000064000000000000008498b38d89c1dc8a448ea5824938ff828926cd9f7747b1844b59b4b6807e878b";
    ...
    void serializeAndSignTransaction() {
        ...
        SignedTransaction lockFundsTransactionSigned = lockFundstx.signWith(account, generationHash);

        String payload = lockFundsTransactionSigned.getPayload();
        assertEquals(payload.substring(240), "44B262C46CEABB85809698000000000064000000000000008498B38D89C1DC8A448EA5824938FF828926CD9F7747B1844B59B4B6807E878B");
        assertEquals("11533C71C8A6F9A86E041AD6EE3B1CBA81FA9E7DDF93AEFB9EB7ACA153BB3E2C", lockFundsTransactionSigned.getHash());
    }
