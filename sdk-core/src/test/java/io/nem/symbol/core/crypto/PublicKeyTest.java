...
public class PublicKeyTest {
  ...
  public void randomUtilsFail() {
    Assertions.assertThrows(
        IllegalIdentifierException.class, () -> RandomUtils.generateRandomBytes(-1));
  }
  ...
  public void canCreateFromHexString() {
    ...
    MatcherAssert.assertThat(
        key.getBytes(),
        IsEqual.equalTo(ByteUtils.byteArrayLeadingZeros(new byte[] {0x22, 0x7F}, PublicKey.SIZE)));
  }
  ...
  public void crateFromBigInt() {
    ...
    // Assert:
    MatcherAssert.assertThat(
        new PublicKey(new BigInteger("2276")), IsNot.not(IsEqual.equalTo(key)));
    Assertions.assertEquals(
        "00000000000000000000000000000000000000000000000000000000000008E3", key.toHex());
  }
  ...
  public void equalsOnlyReturnsTrueForEquivalentObjects() {
    ...
    MatcherAssert.assertThat(
        PublicKey.generateRandom(), IsNot.not(IsEqual.equalTo(PublicKey.fromHexString("2275"))));
  }
