...
public class HashesTest {
  ...
  public void testLeading00Hashes() {
    ...
    MatcherAssert.assertThat(
        ConvertUtils.toHex(privateKey.getBytes()),
  ...
  public void testNoLoadingZeros() {
    ...
    MatcherAssert.assertThat(
        ConvertUtils.toHex(hash),
        IsEqual.equalTo(
            "CE46355C204ECF9CD7FF922B59934C40926759C4651D4BC34CA7B89BF5DF6A22EEE0B5ED6759085057D8AA6E032C76944370E77A81B318B0215EEEFD45DD9C46"));
  ...
  private static void assertHashesAreDifferent(
      final Function<byte[], byte[]> hashFunction1, final Function<byte[], byte[]> hashFunction2) {
