...
public class ByteUtilsTest {
  ...
  public void canConvertLongNegativeToBytes() {
    ...
    assertLongToBytesConversion(1L, new byte[] {0, 0, 0, 0, 0, 0, 0, 1});

    assertLongToBytesConversion(600L, new byte[] {0, 0, 0, 0, 0, 0, 2, 88});
  }
  ...
  public void canConvertBytesToInt() {
    ...
    assertBytesToIntConversion(new byte[] {1, 0, 0, 0}, 0x01000000);
  }
  ...
  public void isEqualReturnsOneIfLoBytesAreEqualButHiBytesAreNot() {
    ...
    MatcherAssert.assertThat(
        ByteUtils.isEqualConstantTime(75 + 256, 75 + 256 * 2), IsEqual.equalTo(1));
  }
  ...
  private void assertBigIntToByteArrayLeadingZeros(String originalHex, int size, String finalHex) {
    ...
    if (finalHex == null) {
      ...
      Assertions.assertEquals(
          "value size "
              + originalBigInteger.toByteArray().length
      ...
      Assertions.assertEquals(
          finalHex,
          ConvertUtils.toHex(ByteUtils.bigIntToByteArrayLeadingZeros(originalBigInteger, size)));
    }
  }
