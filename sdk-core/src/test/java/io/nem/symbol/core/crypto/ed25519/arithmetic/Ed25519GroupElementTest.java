...
public class Ed25519GroupElementTest {
  ...
  public void canBeCreatedWithPrecompCoordinates() {
    ...
    MatcherAssert.assertThat(
        g.getCoordinateSystem(), IsEqual.equalTo(CoordinateSystem.PRECOMPUTED));
  ...
  public void toP2ThrowsIfGroupElementHasPrecompRepresentation() {
    // Arrange:
    final Ed25519GroupElement g =
        MathUtils.toRepresentation(MathUtils.getRandomGroupElement(), CoordinateSystem.PRECOMPUTED);
  ...
  public void toCachedReturnsExpectedResultIfGroupElementHasP3Representation() {
    for (int i = 0; i < 10; i++) {
      ...
      MatcherAssert.assertThat(h1.getZ(), IsEqual.equalTo(g.getZ()));
      MatcherAssert.assertThat(
          h1.getT(), IsEqual.equalTo(g.getT().multiply(Ed25519Field.D_Times_TWO)));
    }
  }
  ...
  // This test is slow (~6s) due to math utils using an inferior algorithm to
  // calculate the
  // result.
  @Test
