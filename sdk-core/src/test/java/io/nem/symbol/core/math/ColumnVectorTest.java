...
import io.nem.symbol.core.test.IsRoundedEqual;
...
public class ColumnVectorTest {
  ...
  public void isZeroVectorReturnsTrueIfAndOnlyIfAllElementsAreZero() {
    ...
    MatcherAssert.assertThat(
        new ColumnVector(-3, 2, -5, 7, -1, 8).isZeroVector(), IsEqual.equalTo(false));
    MatcherAssert.assertThat(
        new ColumnVector(-3, 2, -5, 0, -1, 8).isZeroVector(), IsEqual.equalTo(false));
    MatcherAssert.assertThat(
        new ColumnVector(0, 0, -1, 1, 0, 0).isZeroVector(), IsEqual.equalTo(false));
    MatcherAssert.assertThat(
        new ColumnVector(0, 0, -1, 0, 0, 0).isZeroVector(), IsEqual.equalTo(false));
    MatcherAssert.assertThat(
        new ColumnVector(0, 0, 0, 0, 0, 0).isZeroVector(), IsEqual.equalTo(true));
  }
  ...
  public void hashCodesAreEqualForEquivalentObjects() {
    ...
    MatcherAssert.assertThat(
        new ColumnVector(1, -4, 1).hashCode(), IsNot.not(IsEqual.equalTo(hashCode)));
    MatcherAssert.assertThat(
        new ColumnVector(2, 8, 1).hashCode(), IsNot.not(IsEqual.equalTo(hashCode)));
    MatcherAssert.assertThat(
        new ColumnVector(2, -4, 2).hashCode(), IsNot.not(IsEqual.equalTo(hashCode)));
  }
