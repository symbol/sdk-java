...
public class Ed25519FieldTest {
  ...
  public void zeroIsAsExpected() {
    ...
    MatcherAssert.assertThat(
        BigInteger.ZERO, IsEqual.equalTo(MathUtils.toBigInteger(Ed25519Field.ZERO)));
  }
  ...
  public void oneIsAsExpected() {
    // Assert:
    MatcherAssert.assertThat(
        BigInteger.ONE, IsEqual.equalTo(MathUtils.toBigInteger(Ed25519Field.ONE)));
  }
  ...
  public void dTimesTwoIsAsExpected() {
    ...
    // Assert:
    MatcherAssert.assertThat(
        DTimesTwo, IsEqual.equalTo(MathUtils.toBigInteger(Ed25519Field.D_Times_TWO)));
  }
