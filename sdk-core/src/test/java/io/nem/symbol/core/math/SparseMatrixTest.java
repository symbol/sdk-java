...
import io.nem.symbol.core.test.IsEquivalent;
...
public class SparseMatrixTest extends MatrixTest<SparseMatrix> {
  ...
  public void entryCanBeRemoved() {
    ...
    MatcherAssert.assertThat(
        sparseMatrix, IsEqual.equalTo(this.createMatrix(3, 2, new double[] {2, 0, 5, 11, 1, 8})));
  }
  ...
  public void lastEntryInRowCanBeRemoved() {
    ...
    MatcherAssert.assertThat(
        sparseMatrix, IsEqual.equalTo(this.createMatrix(3, 2, new double[] {0, 0, 5, 11, 1, 8})));
  }
