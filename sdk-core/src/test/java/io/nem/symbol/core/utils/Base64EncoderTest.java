...
public class Base64EncoderTest {
  ...
  public void stringCanBeConvertedToByteArray() {
    ...
    MatcherAssert.assertThat(
        Base64Encoder.getBytes("U2lnbWE="), IsEqual.equalTo(ENCODED_SIGMA_BYTES));
    MatcherAssert.assertThat(
  ...
  public void byteArrayCanBeConvertedToString() {
    // Assert:
    MatcherAssert.assertThat(
        Base64Encoder.getString(ENCODED_SIGMA_BYTES), IsEqual.equalTo("U2lnbWE="));
    MatcherAssert.assertThat(
  ...
  public void malformedStringCannotBeDecoded() {
    ...
    Assertions.assertThrows(
        IllegalArgumentException.class, () -> Base64Encoder.getBytes("BAD STRING)(*&^%$#@!"));
  }
