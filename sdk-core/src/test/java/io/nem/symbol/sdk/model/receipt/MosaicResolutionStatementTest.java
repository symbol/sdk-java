...
public class MosaicResolutionStatementTest {
  ...
  void setupStatement() {
    ...
    MosaicResolutionStatement mosaicResolutionStatement1 =
        new MosaicResolutionStatement(
            ...
            Arrays.asList(
                new ResolutionEntry<>(
                    mosaicId1, new ReceiptSource(1, 0), ReceiptType.MOSAIC_ALIAS_RESOLUTION),
                new ResolutionEntry<>(
                    mosaicId2, new ReceiptSource(3, 5), ReceiptType.MOSAIC_ALIAS_RESOLUTION)));

    MosaicResolutionStatement mosaicResolutionStatement2 =
        new MosaicResolutionStatement(
            "abc",
            height,
            mosaicNamespace3,
            Collections.singletonList(
                new ResolutionEntry<>(
                    mosaicId3, new ReceiptSource(3, 1), ReceiptType.MOSAIC_ALIAS_RESOLUTION)));

    MosaicResolutionStatement mosaicResolutionStatement3 =
        new MosaicResolutionStatement(
            "abc",
            height2,
            mosaicNamespace4,
            Arrays.asList(
                new ResolutionEntry<>(
                    mosaicId1, new ReceiptSource(1, 1), ReceiptType.MOSAIC_ALIAS_RESOLUTION),
                new ResolutionEntry<>(
                    mosaicId2, new ReceiptSource(1, 4), ReceiptType.MOSAIC_ALIAS_RESOLUTION),
                new ResolutionEntry<>(
                    mosaicId3, new ReceiptSource(1, 7), ReceiptType.MOSAIC_ALIAS_RESOLUTION),
                new ResolutionEntry<>(
                    mosaicId4, new ReceiptSource(2, 4), ReceiptType.MOSAIC_ALIAS_RESOLUTION)));

    mosaicResolutionStatements =
        Arrays.asList(
            mosaicResolutionStatement1, mosaicResolutionStatement2, mosaicResolutionStatement3);
  }

  @Test
  void shouldGetResolvedEntryWhenPrimaryIdIsGreaterThanMaxMosaicId() {
    Optional<MosaicId> resolved =
        MosaicResolutionStatement.getResolvedMosaicId(
            mosaicResolutionStatements, height, mosaicNamespace1, 4, 0);
  ...
  void shouldNotResolveMosaicIdWhenInvalidHeight() {
    Optional<MosaicId> resolved =
        MosaicResolutionStatement.getResolvedMosaicId(
            mosaicResolutionStatements, height2, addressNamespace1, 4, 0);
  ...
  void shouldGetResolvedEntryWhenPrimaryIdIsInMiddleOf2PirmaryIds() {
    Optional<MosaicId> resolved =
        MosaicResolutionStatement.getResolvedMosaicId(
            mosaicResolutionStatements, height, mosaicNamespace1, 2, 1);
    Assertions.assertTrue(resolved.isPresent());
  ...
  void shouldGetResolvedEntryWhenPrimaryIdMatchesButNotSecondaryId() {
    Optional<MosaicId> resolved =
        MosaicResolutionStatement.getResolvedMosaicId(
            mosaicResolutionStatements, height, mosaicNamespace1, 3, 6);
    Assertions.assertTrue(resolved.isPresent());
    Assertions.assertEquals(mosaicId2, resolved.get());
  }
  ...
  void resolutionChangeInTheBlockMoreThanOneAggregate() {
    assertEquals(
        Optional.of(mosaicId1),
        MosaicResolutionStatement.getResolvedMosaicId(
            mosaicResolutionStatements, height2, mosaicNamespace4, 1, 1));

    assertEquals(
        Optional.of(mosaicId2),
        MosaicResolutionStatement.getResolvedMosaicId(
            mosaicResolutionStatements, height2, mosaicNamespace4, 1, 4));

    assertEquals(
        Optional.of(mosaicId3),
        MosaicResolutionStatement.getResolvedMosaicId(
            mosaicResolutionStatements, height2, mosaicNamespace4, 1, 7));

    assertEquals(
        Optional.of(mosaicId3),
        MosaicResolutionStatement.getResolvedMosaicId(
            mosaicResolutionStatements, height2, mosaicNamespace4, 2, 1));

    assertEquals(
        Optional.of(mosaicId4),
        MosaicResolutionStatement.getResolvedMosaicId(
            mosaicResolutionStatements, height2, mosaicNamespace4, 2, 4));

    assertEquals(
        Optional.empty(),
        MosaicResolutionStatement.getResolvedMosaicId(
            mosaicResolutionStatements, height2, mosaicNamespace4, 1, 0));

    assertEquals(
        Optional.of(mosaicId2),
        MosaicResolutionStatement.getResolvedMosaicId(
            mosaicResolutionStatements, height2, mosaicNamespace4, 1, 6));

    assertEquals(
        Optional.of(mosaicId1),
        MosaicResolutionStatement.getResolvedMosaicId(
            mosaicResolutionStatements, height2, mosaicNamespace4, 1, 2));
  }
}
