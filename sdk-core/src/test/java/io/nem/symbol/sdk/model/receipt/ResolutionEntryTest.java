...
public class ResolutionEntryTest {
  ...
  void shouldCreateAddressResolutionEntry() {
    ...
    assertEquals(
        "0100000001000000" + address.encoded(), ConvertUtils.toHex(resolutionEntry.serialize()));
  }
  ...
  void shouldCreateMosaicResolutionEntry() {
    ...
    ResolutionEntry<MosaicId> resolutionEntry =
        ResolutionEntry.forMosaicId(mosaicId, receiptSource);
    ...
    assertEquals(
        "010000000100000044B262C46CEABB85", ConvertUtils.toHex(resolutionEntry.serialize()));
  }
