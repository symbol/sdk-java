...
class HashLockSearchCriteriaTest {
    ...
    void shouldUseBuilderMethods() {
        ...
        HashLockSearchCriteria criteria = new HashLockSearchCriteria(account1.getAddress()).order(OrderBy.ASC)
    ...
    void shouldBeEquals() {
        ...
        Assertions.assertEquals(new HashLockSearchCriteria(account1.getAddress()),
            new HashLockSearchCriteria(account1.getAddress()));
        Assertions.assertNotEquals(new HashLockSearchCriteria(account1.getAddress()),
