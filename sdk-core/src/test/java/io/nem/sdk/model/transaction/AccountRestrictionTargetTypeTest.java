...
public class AccountRestrictionTargetTypeTest {
    ...
    public void shouldFailWhenInvalidAddress() {
        ...
        Assertions.assertEquals(
            "Value 'TTTT' cannot be converted to ADDRESS. Error: IllegalArgumentException: TTTT could not be decoded. DecoderException: Illegal hexadecimal character T at index 0",
            Assertions
