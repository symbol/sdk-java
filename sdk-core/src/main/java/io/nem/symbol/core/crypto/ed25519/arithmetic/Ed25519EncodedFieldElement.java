...
/**
 * Represents a field element of the finite field with p=2^255-19 elements. The value of the field
...
public class Ed25519EncodedFieldElement implements Serializable {
    ...
    /**
     * Decodes this encoded (32 byte) representation to a field element in its 10 byte 2^25.5
     * representation. The most significant bit is discarded.
     *
    ...
    /**
     * Multiplies this encoded field element with another and adds a third. The result is reduced
     * modulo the group order. <br> See the comments in the method modQ() for an explanation of the
     * algorithm.
     *
     ...
     */
    public Ed25519EncodedFieldElement multiplyAndAddModQ(
