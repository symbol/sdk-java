...
public class AESGCM {
     ...
     */
    private static GCMBlockCipher createAESGCMCipher(final byte[] secretKey, final boolean forEncryption,
        final byte[] iv) {
     ...
     */
    public static AuthenticatedCipherText encrypt(final byte[] secretKey, final byte[] iv, final byte[] plainText)
     ...
     */
    public static byte[] decrypt(final byte[] secretKey, final byte[] iv, final byte[] cipherText, final byte[] authTag)
        throws RuntimeException {
