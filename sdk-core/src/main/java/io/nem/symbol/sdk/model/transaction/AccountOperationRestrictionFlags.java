...
public enum AccountOperationRestrictionFlags implements AccountRestrictionFlags {
     ...
     * @return Enum value.
     */
    public static AccountOperationRestrictionFlags rawValueOf(final int value) {
