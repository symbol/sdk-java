...
public interface TransactionService {
     ...
     * socket, a {@link TransactionStatusException} is raised.
     *
     * Steps:
     *
     ...
     * to the /status web socket, a {@link TransactionStatusException}
     * is raised.
     *
     * Steps:
     *
     ...
     * a {@link TransactionStatusException} if the transaction has
     * failed.
     */
     ...
     * that raises a {@link TransactionStatusException} if any
     ...
     *
     * For example, if a {@link TransferTransaction}'s recipient was
     * 'customerone' {@link NamespaceId}, this method will return the
     * same {@link TransferTransaction} where the recipient is the real
     * {@link Address}.
     *
     * Similarly, if {@link MosaicMetadataTransaction} was announced
     * using the {@link NamespaceId} alias of the mosaic, the returned
     * {@link MosaicMetadataTransaction} will reference the real {@link
     * MosaicId}.
     *
     * All the {@link UnresolvedMosaicId} and {@link
     * UnresolvedAddress} in the returned transaction should be instances
     * of {@link MosaicId} and {@link Address}
     *
