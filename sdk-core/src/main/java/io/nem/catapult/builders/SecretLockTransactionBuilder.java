...
public final class SecretLockTransactionBuilder extends TransactionBuilder {
     ...
     */
    protected SecretLockTransactionBuilder(final SignatureDto signature, final KeyDto signer,
     ...
     */
    public static SecretLockTransactionBuilder create(final SignatureDto signature,
        final KeyDto signer, final short version, final EntityTypeDto type, final AmountDto fee,
        final TimestampDto deadline, final UnresolvedMosaicBuilder mosaic,
        final BlockDurationDto duration, final LockHashAlgorithmDto hashAlgorithm,
        final Hash256Dto secret, final UnresolvedAddressDto recipient) {
        return new SecretLockTransactionBuilder(signature, signer, version, type, fee, deadline,
            mosaic, duration, hashAlgorithm, secret, recipient);
    }
