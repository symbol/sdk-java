...
final class ModifyMultisigAccountTransactionBodyBuilder {
   ...
   */
  protected ModifyMultisigAccountTransactionBodyBuilder(
   ...
   */
  public static ModifyMultisigAccountTransactionBodyBuilder create(
      final byte minRemovalDelta,
      final byte minApprovalDelta,
      final ArrayList<CosignatoryModificationBuilder> modifications) {
    return new ModifyMultisigAccountTransactionBodyBuilder(
