...
public final class MosaicSupplyChangeTransactionBuilder extends TransactionBuilder {
   ...
   */
  protected MosaicSupplyChangeTransactionBuilder(
   ...
   */
  public static MosaicSupplyChangeTransactionBuilder create(
      final SignatureDto signature,
      final KeyDto signer,
      final short version,
      final EntityTypeDto type,
    ...
    return new MosaicSupplyChangeTransactionBuilder(
        signature, signer, version, type, fee, deadline, mosaicId, direction, delta);
  }
