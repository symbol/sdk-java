 ...
 */
final class AccountAddressRestrictionTransactionBodyBuilder {
    ...
    protected AccountAddressRestrictionTransactionBodyBuilder(final DataInput stream) {
        try {
            ...
            for (int i = 0; i < modificationsCount; i++) {
                modifications
                    .add(AccountAddressRestrictionModificationBuilder.loadFromBinary(stream));
            }
        } catch (Exception e) {
     ...
     */
    protected AccountAddressRestrictionTransactionBodyBuilder(
     ...
     */
    public static AccountAddressRestrictionTransactionBodyBuilder create(
        final AccountRestrictionTypeDto restrictionType,
        final ArrayList<AccountAddressRestrictionModificationBuilder> modifications) {
     ...
     * @return Instance of AccountAddressRestrictionTransactionBodyBuilder.
     */
    public static AccountAddressRestrictionTransactionBodyBuilder loadFromBinary(
