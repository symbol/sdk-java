...
public class AggregateTransaction extends Transaction {
    ...
    public AggregateTransaction(NetworkType networkType, TransactionType transactionType,
        Integer version, Deadline deadline,
        BigInteger fee, List<Transaction> innerTransactions,
    ...
    private AggregateTransaction(NetworkType networkType, TransactionType transactionType,
        Integer version, Deadline deadline,
        BigInteger fee, List<Transaction> innerTransactions,
        List<AggregateTransactionCosignature> cosignatures,
     ...
     */
    public SignedTransaction signTransactionWithCosigners(final Account initiatorAccount,
        ...
        return new SignedTransaction(Hex.toHexString(payloadBytes), signedTransaction.getHash(),
            getType());
    }
