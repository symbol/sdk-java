...
public final class SecretProofTransactionBuilder extends TransactionBuilder {
   ...
   */
  protected SecretProofTransactionBuilder(
   ...
   */
  public static SecretProofTransactionBuilder create(
      final SignatureDto signature,
      final KeyDto signer,
      final short version,
      final EntityTypeDto type,
    ...
    return new SecretProofTransactionBuilder(
        signature, signer, version, type, fee, deadline, hashAlgorithm, secret, recipient, proof);
  }
