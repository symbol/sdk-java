...
public final class AccountMosaicRestrictionTransactionBuilder extends TransactionBuilder {
  ...
  private final AccountMosaicRestrictionTransactionBodyBuilder
  ...
  protected AccountMosaicRestrictionTransactionBuilder(final DataInput stream) {
    super(stream);
    this.accountMosaicRestrictionTransactionBody =
  ...
  protected AccountMosaicRestrictionTransactionBuilder(
    ...
    this.accountMosaicRestrictionTransactionBody =
        AccountMosaicRestrictionTransactionBodyBuilder.create(restrictionType, modifications);
  }
   ...
   */
  public static AccountMosaicRestrictionTransactionBuilder create(
      final SignatureDto signature,
      final KeyDto signer,
      final short version,
      final EntityTypeDto type,
  ...
  public byte[] serialize() {
    return GeneratorUtils.serialize(
        dataOutputStream -> {
          ...
          final byte[] accountMosaicRestrictionTransactionBodyBytes =
              this.accountMosaicRestrictionTransactionBody.serialize();
          dataOutputStream.write(
              accountMosaicRestrictionTransactionBodyBytes,
              0,
