...
class NamespaceRegistrationTransactionMapper
    extends AbstractTransactionMapper<
        NamespaceRegistrationTransactionDTO, NamespaceRegistrationTransaction> {
  ...
  protected TransactionFactory<NamespaceRegistrationTransaction> createFactory(
    ...
    return NamespaceRegistrationTransactionFactory.create(
        ...
        namespaceRegistrationType == NamespaceRegistrationType.SUB_NAMESPACE
            ? Optional.of(MapperUtils.toNamespaceId(transaction.getParentId()))
            : Optional.empty());
  }

  @Override
  protected void copyToDto(
      NamespaceRegistrationTransaction transaction, NamespaceRegistrationTransactionDTO dto) {
    ...
    dto.setRegistrationType(
        NamespaceRegistrationTypeEnum.fromValue(
