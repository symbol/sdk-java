...
public class TransactionMappingVertx implements Function<TransactionInfoDTO, Transaction> {
    ...
    public TransactionMappingVertx(JsonHelper jsonHelper) {
...
class TransferTransactionMapping extends TransactionMappingVertx {
...
class NamespaceCreationTransactionMapping extends TransactionMappingVertx {
...
class MosaicCreationTransactionMapping extends TransactionMappingVertx {
...
class MosaicSupplyChangeTransactionMapping extends TransactionMappingVertx {
...
class MultisigModificationTransactionMapping extends TransactionMappingVertx {
...
class AggregateTransactionMapping extends TransactionMappingVertx {
...
//
                ...
                return new TransactionMappingVertx(getJsonHelper()).apply(transactionInfoDTO);
...
class LockFundsTransactionMapping extends TransactionMappingVertx {
...
class SecretLockTransactionMapping extends TransactionMappingVertx {
...
class SecretProofTransactionMapping extends TransactionMappingVertx {
...
class AccountLinkTransactionMapping extends TransactionMappingVertx {
