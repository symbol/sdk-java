...
class ReceiptRepositoryMosaicSearchIntegrationTest extends BaseIntegrationTest {
    ...
    private PaginationTester<MosaicResolutionStatement, ResolutionStatementSearchCriteria> getPaginationTester(
        RepositoryType type) {
        return new PaginationTester<>(ResolutionStatementSearchCriteria::new,
            getReceiptRepository(type)::searchMosaicResolutionStatements);
    }
