...
public class ReceiptMappingOkHttpTest {
    ...
    public void getMosaicResolutionStatementHash() {
        ...
        List<ResolutionStatementInfoDTO> dtos = jsonHelper
            .parseList(TestHelperOkHttp.loadResource("Recipient-MosaicResolutionStatement.json"),
    ...
    public void getAddressResolutionStatementsHash() {
        List<ResolutionStatementInfoDTO> dtos = jsonHelper
            .parseList(TestHelperOkHttp.loadResource("Recipient-AddressResolutionStatement.json"),
                ResolutionStatementInfoDTO.class);
