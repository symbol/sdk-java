...
```compile 'io.nem:symbol-sdk-vertx-client:20.0```

OR

```compile 'io.nem:symbol-sdk-okhttp-client:20.0```

### SBT

```libraryDependencies += "io.nem" % "symbol-sdk-vertx-client" % "20.0"```

OR

```libraryDependencies += "io.nem" % "symbol-sdk-okhttp-client" % "20.0"```
