...
public class Http {
    ...
    Http(String host, NetworkHttp networkHttp) {
        try {
            this.url = new URL(host);
        } catch (MalformedURLException e) {
            throw new IllegalStateException("Host " + host + " is not a valid url: ", e);
        }
    ...
    static BigInteger extractBigInteger(List<Long> list) {
