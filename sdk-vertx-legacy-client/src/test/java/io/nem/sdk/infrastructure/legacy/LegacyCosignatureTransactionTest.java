...
public class LegacyCosignatureTransactionTest {
    ...
    void createACosignatureTransactionViaConstructor() throws Exception {
        ...
        JsonObject aggregateTransactionDTO =
            new JsonObject(
        ...
        AggregateTransaction aggregateTransaction =
            (AggregateTransaction) new TransactionMappingLegacy().apply(aggregateTransactionDTO);
